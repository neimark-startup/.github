...
> Багтрекер находится по адресу: [https://github.com/neimark-startup/neimark-startup/issues](https://github.com/neimark-startup/neimark-startup/issues)
...
1. Для создания новой задачи перейди на вкладку `Issues`.
	- ![](https://raw.githubusercontent.com/unngrouponce/unn\_grouponce/master/docs/Update/Kulikov/data/issue-1.png)
2. Нажми на кнопку `New issue`.
	- ![](https://raw.githubusercontent.com/unngrouponce/unn\_grouponce/master/docs/Update/Kulikov/data/issue-2.png)
3. Опиши задачу.
	- ![](https://raw.githubusercontent.com/unngrouponce/unn\_grouponce/master/docs/Update/Kulikov/data/issue-3.png)
4. В меню `Assignees` назнач задачу одному или нескольким участникам команды.
	- ![](https://raw.githubusercontent.com/neimark-startup/.github/refs/heads/main/data/issue/issue-4.png)
5. В меню `Labels` определи категорию задачи.
	- ![](https://raw.githubusercontent.com/unngrouponce/unn\_grouponce/master/docs/Update/Kulikov/data/issue-5.png)
6. Сохрани задачу нажав на кнопку `Submit new issue`.
	- ![](https://raw.githubusercontent.com/unngrouponce/unn\_grouponce/master/docs/Update/Kulikov/data/issue-6.png)
...
![](https://raw.githubusercontent.com/unngrouponce/unn\_grouponce/master/docs/Update/Kulikov/data/issue-7.png)